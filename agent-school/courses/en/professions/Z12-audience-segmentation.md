> 🌐 English ｜ [中文](../../professions/Z12-audience-segmentation.md)
...
All boxes checked, proctor says pass — log it on your progress card, then file the [graduation report](../../../templates/graduation-report-template.md) and hand the analysis report directly to the owner.
